            ...
            {panier.length === 0 ? (
              ...
              <div className="mt-6 space-y-4">
                {panier.map((produit, index) => (
                  <div key={ produit._id || index} className="flex items-center gap-4 border-b py-4">
                    <Image src={produit.image || "/images/default.jpg"}
                           alt={produit.title} 
                    ...
                    <div className="flex-1">
                      ...
                      <p>{produit.price} x {produit.quantite} F</p>
                    </div>
                  </div>
                ))}

                <p className="text-lg font-bold mt-4 text-right">Total : {total.toFixed(2)} F</p>
              </div>
            )}
          </div>
        </div>
